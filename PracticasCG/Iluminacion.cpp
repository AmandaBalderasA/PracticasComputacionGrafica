...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Materiales e Iluminacion - Amanda", nullptr, nullptr);
    ...
    Model sun((char*)"Models/sun_sphere/ba4da2b78df2_sun_sphere__3d_asse.obj");
    Model moon((char*)"Models/moon/0938f329f44d_moon__3d_asset_0_gl.obj");
...
void DoMovement()
{
    ...
    // Movimiento circular para la luz
    lightPos.x = radius * cos(lightAngle);
    lightPos.y = radius * sin(lightAngle);
